...
![Workspace creation form in Postman]( /_static/imgs/postman-workspace-creation.png)
...
![Creating a collection in Postman]( /_static/imgs/postman-create-collection.png)
...
![Adding a GET request in Postman]( /_static/imgs/postman-get-catapi-breeds.png)
...
![Query parameters in Postman]( /_static/imgs/postman-query-params-catapi.png)
