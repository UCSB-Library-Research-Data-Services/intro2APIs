...
![POSTMAN images collection]( /_static/imgs/postman-images-collection.png)
...
![POSTMAN Body file-form attached file]( /_static/imgs/postman-post-prepare.png)

Now you can send the request. If it’s successful, you’ll see a response like this:

![POSTMAN POST request success message]( /_static/imgs/postman-post-success.png)
